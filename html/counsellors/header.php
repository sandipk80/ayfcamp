            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <ul class="list-unstyled list-inline">
                        ...
                        ?>
                        <li>Welcome <?php echo isset($_SESSION['ayfcamp']['counsellor']['name']) ? $_SESSION['ayfcamp']['counsellor']['name'] : "";?></li>
                        
                        <li>
                            <i class="fa fa-sign-out"></i> <a href="<?php echo COUNSELLOR_SITE_URL;?>logout.php">Logout</a>
                        </li>
                        <?php
                        }else{
                        ?>
                        <li>
                            <i class="fa fa-sign-in"></i> <a href="<?php echo COUNSELLOR_SITE_URL;?>login.php">User Login</a>
                        </li>
                        <li>
                            <i class="fa fa-user"></i> <a href="<?php echo COUNSELLOR_SITE_URL;?>signup.php">Signup</a>
                        </li>
                        <?php
                        }
                        ?>
        ...
        <nav id="nav" class="navbar navbar-default" role="navigation">
            <div class="container-fluid bot-border">
                ...
                <div class="navbar-header">
                    ...
                    <!-- Logo Starts -->
                    <a href="<?php echo COUNSELLOR_SITE_URL;?>" class="navbar-brand">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li id="registerCamp">
                            <a href="<?php echo COUNSELLOR_SITE_URL;?>home.php">Home</a>
                        </li>                        
                    </ul>
                </div>
