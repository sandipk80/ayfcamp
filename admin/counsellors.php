...
include(LIB_PATH . 'admin/counsellors/index-init.php');
                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($result) && count($result)>0){
                                            foreach($result as $row){
                                                $deleteItem=ADMIN_SITE_URL."counsellors.php?act=delete&id=".$row['id'];
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['gender']=="F" ? "Female" : "Male";?></td>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="<?php echo ADMIN_SITE_URL.'counsellor-applications.php?cid='.$row['id'];?>">View Applications</a>
...
$(document).on("click", ".updateStatus", function (e) {
    ...
    if(confirm("Are you sure want to update the status of this counsellor?")) {
        $.ajax({
            url:'<?php echo AJAX_PATH;?>admin/ajaxUpdateStatus.php',
            dataType: "json",
            method: "post",
            data: {id:id,st:status,tb:'counsellors'},
            cache: false,
