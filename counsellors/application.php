<?php
include('../cnf.php');
require_once(LIB_PATH.'counsellors/applications/application1-init.php');
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="camp_session_id[]" class="form-control ddcampsessions" multiple>
                                                <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="alt_camp_session_id[]" class="form-control ddcampsessions" multiple>
                                                <?php
                                                if(is_array($camp['sessions']) && count($camp['sessions'])>0){
                                                    foreach($camp['sessions'] as $session){
                                                        $dateRange = date("l F d, Y", strtotime($session['start_from'])).' to '.date("l F d, Y", strtotime($session['end_at']));
                                    ...
                                    <div class="input_fields_wrap">
                                        <div class="blkhdr">Employer 1</div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Nature of Work Performed </label>
                                                <input type="text" class="form-control" name="work_nature[]" value="">
                                            </div>
                                        </div>

                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="email">Employer Address & Phone </label>
                                                <input type="text" class="form-control" name="employer_info[]" value="">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="input_fields_wrap">
                                        <div class="blkhdr">Employer 2</div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Employer Name </label>
                                                <input type="text" class="form-control" name="employer_name[]" value="">
                                    ...
                                    <div class="input_fields_wrap">
                                        <div class="blkhdr">Employer 3</div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Employer Name </label>
                                                <input type="text" class="form-control" name="employer_name[]" value="">
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            <label for="email">Indicate any employer you do not wish us to contact and the reason: </label>
                                            <textarea class="form-control" name="employer_indications" id="employer_indications" rows="5"><?php echo $employer_indications;?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="blkhdr">Give the names and addresses of three persons (not relatives) having knowledge of your character, experience, work habits, and ability.</div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">Reference 1: Name, address & phone <span class="required">*</span></label>
                                            <input type="text" class="form-control required" name="reference1" id="reference1" value="<?php echo $reference1;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">Reference 2: Name, address & phone <span class="required">*</span></label>
                                            <input type="text" class="form-control required" name="reference2" id="reference2" value="<?php echo $reference2;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">Reference 3: Name, address & phone <span class="required">*</span></label>
                                            <input type="text" class="form-control required" name="reference3" id="reference3" value="<?php echo $reference3;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_fields_wrap">
                                        <div class="blkhdr">School 1</div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Years </label>
                                                <input type="text" class="form-control" name="edu_year[]" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Degree Granted </label>
                                                <input type="text" class="form-control" name="degree_granted[]" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input_fields_wrap">
                                        <div class="blkhdr">School 2</div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Years </label>
                                                <input type="text" class="form-control" name="edu_year[]" value="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">Please list any skills you have that may apply to the camp program</label>
                                            <textarea class="form-control" rows="5" name="skills" id="skills"><?php echo $skills;?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">What contributions do you think you can make at AYF Camp? How do you think AYF Camp affects the children that attend?</label>
                                            <textarea class="form-control" rows="5" name="contributions" id="contributions"><?php echo $skills;?></textarea>
                                        </div>
                                    </div>
